...
def split_by_character():
    ...
    print("CharacterTextSplitter parameters:")
    print(f"- Chunk size: {text_splitter.chunk_size}")
    print(f"- Chunk overlap: {text_splitter.chunk_overlap}")
    print(f"- Length function: {text_splitter.length_function}")
    # Note: separator is set during initialization, not stored as an attribute
...
def split_recursively_by_character():
    ...
    print("RecursiveCharacterTextSplitter parameters:")
    print(f"- Chunk size: {text_splitter.chunk_size}")
    print(f"- Chunk overlap: {text_splitter.chunk_overlap}")
    print(f"- Length function: {text_splitter.length_function}")
    # Note: separators are set during initialization, not stored as an attribute
...
def split_code():
    ...
    # Show Python separators
    print(f"\nPython separators: {RecursiveCharacterTextSplitter.get_separators_for_language(Language.PYTHON)}")
    ...
    print("\n--- JavaScript Code Splitting ---")
    print(f"JavaScript separators: {RecursiveCharacterTextSplitter.get_separators_for_language(Language.JS)}")
...
def split_by_html():
    """Demonstrate splitting HTML by headers and sections"""
    print("\n=== Split by HTML ===")
    ...
    try:
        ...
        print(f"\n✓ HTML split by headers into {len(html_header_splits)} chunks")
        ...
        print("⚠ HTMLHeaderTextSplitter not available. Install langchain-text-splitters.")
    ...
    try:
        ...
        print(f"✓ HTML split by sections into {len(html_header_splits)} chunks")
        ...
        print("⚠ HTMLSectionSplitter not available. Install langchain-text-splitters.")
...
def exercises():
    ...
    try:
        ...
        print(f"⚠ Error splitting LaTeX: {e}")
